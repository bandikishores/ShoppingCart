...
<div class="main">
  <div class="header">
    <div class="logo">
      <h1><a href="index.html">Welcome to<span> OSM</span> <small>Bangalore's best online shopping mall</small></a></h1>
    </div>
    <div class="menu_nav">
      <ul>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome to Shopping Cart</span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2><span>You have successfully logged in</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
